...
![](media/multi-armed-bandit-trials.gif)

before training, `p=0.92` (left) vs. after training, `p=0.76` (right); [source](https://hackernoon.com/learning-policies-for-learning-policies-meta-reinforcement-learning-rl%C2%B2-in-tensorflow-b15b592a2ddf)
...
![](media/embedded-agents.png)

[source](https://www.lesswrong.com/s/Rm6oQRJJmhGCcLvxh/p/p7x32SEt43ZMC9r7r)
...
![](media/wang-et-all-2018-fig5a.png)

Two-step task. Adapted from [Wang et al, 2018 Nature Neuroscience](https://www.nature.com/articles/s41593-018-0147-8), Fig. 5a
...
![](media/Screen-Shot-2019-03-23-at-2.20.01-PM.png)

canonical model-free(left) vs. canonical model-based(right)(From Figure 5 in [Wang et al, 2018 Nature Neuroscience](https://www.nature.com/articles/s41593-018-0147-8))
...
![](media/meta-rl-arch.jpg)

Meta-RL architecture. Adapted from [Wang et al, 2018 Nature Neuroscience](https://www.nature.com/articles/s41593-018-0147-8), Fig. 1a
...
For reference: canonical model-free (left) vs. canonical model-based (right) (From Figure 5 in [Wang et al, 2018 Nature Neuroscience](https://www.nature.com/articles/s41593-018-0147-8))
...
![](media/harlow-task-monkey.jpg)

[source](https://www.sciencedaily.com/images/2007/08/070801161511_1_540x360.jpg)
...
![](media/6-trials-preprocessed-input.gif)
...
![](media/processing-steps-summary.png)
